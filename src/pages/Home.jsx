    ...
    return (
        <div>
            ...
            <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col items-center justify-between gap-8 text-white">
                ...
                {/*HW: Add light blue shadow to top and left and  dark white shadow to bottom and right - DONE*/}
                <div
                // style={{
                //     WebkitBoxShadow: '-16px -31px 79px -54px rgba(255, 255, 255, 1)',
                //     MozBoxShadow: '-16px -31px 79px -54px rgba(255, 255, 255, 1)',
                //     boxShadow: '-16px -31px 79px -54px rgba(255, 255, 255, 1)',
                // }}
            ...
            <div className="bg-pure-greys-5 text-richblack-700 ">
                <div className="homepage_bg h-[320px]">
                    ...
                    <div className="mx-auto flex w-11/12 max-w-maxContent flex-col items-center justify-between gap-8">
                        <div className="lg:h-[150px]">{/*Empty DIV */}</div>
